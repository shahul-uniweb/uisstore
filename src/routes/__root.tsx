...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Lovable App" },
      { name: "description", content: "Uniweb Launchpad creates modern, animated, mobile-first landing pages for e-commerce solutions." },
      { name: "author", content: "Lovable" },
      { property: "og:title", content: "Lovable App" },
      { property: "og:description", content: "Uniweb Launchpad creates modern, animated, mobile-first landing pages for e-commerce solutions." },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary" },
      { name: "twitter:site", content: "@Lovable" },
      { name: "twitter:title", content: "Lovable App" },
      { name: "twitter:description", content: "Uniweb Launchpad creates modern, animated, mobile-first landing pages for e-commerce solutions." },
