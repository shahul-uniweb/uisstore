...
const plans = [
  {
    ...
    features: [
      ...
      "Kuwait Delivery Partner Included",
      "1 Admin User",
      "Hosting",
  ...
  },
  {
    ...
    features: [
      ...
      "GCC Countries Delivery",
      "Kuwait Delivery Partner Included",
      "Separate Customer Database & Login",
      "Popup Ad Banner",
      "10 Admin Users",
      "Standard SEO Setup",
      "Hosting",
...
const comparisonRows: { feature: string; values: (string | true)[] }[] = [
  ...
  { feature: "Kuwait Delivery Partner", values: [true, true, true, true] },
  { feature: "Point of Sales (P.O.S)", values: ["—", "—", "—", true] },
  { feature: "Separate Customer DB & Login", values: ["—", "—", true, true] },
  { feature: "Popup Ad Banner", values: ["—", "—", true, true] },
